...
export default function (data) {
    ...
    const bookingCoursePayloadV1 = {
        member_code: data.members[0].code,  // Use the first member code from the setup
        course_code: data.courses[0].code,  // Use the first course code from the setup
    };
    ...
    check(bookingCourseV1Response, {
        'booking course V1 status is 200': (r) => r.status === 200,
    });
    ...
    check(bookingCourseV2Response, {
        'booking course V2 status is 200': (r) => r.status === 200,
    });
