...
func (s *service) Booking(ctx context.Context, request BookingRequest) (*Booking, error) {
	ctx, span := tracing.StartSpan(ctx, "service.Booking")
	defer span.End()
	span.SetAttributes(
...
func (s *service) BookingV2(ctx context.Context, request BookingRequest) (*Booking, error) {
	ctx, span := tracing.StartSpan(ctx, "service.BookingV2")
	defer span.End()
	span.SetAttributes(
		attribute.String("member.code", request.MemberCode),
		attribute.String("course.code", request.CourseCode),
	...
	go func() {
		mCtx, mSpan := tracing.StartSpan(ctx, "client.FindMemberByCode")
		defer mSpan.End()
	...
	go func() {
		cCtx, cSpan := tracing.StartSpan(ctx, "client.ReserveCourseByCode")
		defer cSpan.End()
